...
def main():
    ...
    if (args.json):
        ...
        output["current_device_time"] = controller.get_rtc()
        ...
        output["battery_voltage_control_register_names"] = controller.battery_voltage_control_register_names)
        output["battery_voltage_control_registers"] = controller.get_battery_voltage_control_registers()
